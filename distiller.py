...
class Distiller(keras.Model):
    ...
    def train_step(self, data):
        ...
        # average_teacher_predictions = sum(teacher_predictions[:]) / len(self.teacher)
        average_teacher_predictions = teacher_predictions[0]
        ...
        with tf.GradientTape() as tape:
            ...
            distillation_loss = (
                self.distillation_loss_fn(
                    tf.nn.softmax(average_teacher_predictions / self.temperature, axis=1),
